            ...
            <div>
              ...
              ${i.length?R`
                <div class="field-line" style="margin-top:.25rem; display:flex; align-items:center; justify-content:space-between;">
                  ...
                  <div class="summary">${o.length} work item${1===o.length?"":"s"} - <strong>${this.currency}${this.jobTotal(t).toFixed(2)}</strong></div>
                </div>
              `:R`
