      ...
      <div class="mt-3">
        ${this.debugMode?H`
          ...
          <div class="json-debug-area mt-2" style="user-select:text;">
            <div class="d-flex mb-2 gap-2">
              <button class="btn btn-sm btn-outline-secondary" @click="${()=>this.copyToClipboard((this._editedSchema||JSON.stringify(this.buildSchemaFromJson(t),null,2)).replace(/"/g,'\\"'))}">Copy Schema</button>
            </div>
